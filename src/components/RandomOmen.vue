<template>
  <div class="row text-center">
    <div class="col-12">
      ...
      <p
        class="my-3"
      >یکی از آئین های ایرانیان در شب یلدا خواندن شعرهای حافظ و تفال بر دیوان لسان الغیب است.
      نیت کنید و فال حافظتون رو ببینید
      </p>
    ...
    <div class="col-12">
      <b-modal id="my-modal" scrollable centered>
        <b-card bg-variant="danger" text-variant="white" title="فال شما" class="mb-2">
          <b-card-text>
